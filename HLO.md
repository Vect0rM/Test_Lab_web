...
# **Высокоуровневое описание деталей (bold)**
...
# **Технические подробности проекта (bold)**: Сайт разработан полностью с использованием базы данных Mysqli, HTML, CSS, Java Sping MVC, Bootstrap.
